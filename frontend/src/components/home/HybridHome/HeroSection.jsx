...
import { FaUpload, FaQuestionCircle, FaChevronDown } from 'react-icons/fa';
...
export function HeroSection({ onUploadSuccess }) {
    ...
    const onDrop = useCallback((acceptedFiles) => {
        ...
        // Simulate analysis
        setTimeout(() => {
            // Trigger success callback with mock data
            onUploadSuccess?.({
                percentage: 67,
                topPercentile: 23,
                        ...
                        {uploadState === 'idle' && (
                            ...
                            >
                                ...
                                <div className="mt-4 flex flex-col sm:flex-row items-center justify-center gap-4 text-sm text-text-dim">
                                    <span className="font-sans">Gratis · Privado · Sin registro · 3 segundos</span>
                                    <button
                                        onClick={(e) => {
                                            e.stopPropagation();
                        ...
                        {uploadState === 'error' && (
                            ...
                            >
                                ...
                                <p className="text-sm text-text-dim mb-4">
                                    Busca <code className="bg-black/10 px-1">rep_persistentgamedata1.dat</code>
                                </p>
                                <button
                                    onClick={resetUpload}
    ...
    return (
        ...
        >
            <motion.div
                ...
                className="w-full max-w-md bg-bg-paper border-[3px] border-black shadow-[6px_6px_0px_#000] p-6"
